...
function renderFlow() {
  ...
  if (flow.mode === "parallel") {
    ...
    inputNodes.forEach((step, idx) => group.appendChild(drawStep(step, selectedUnit, idx)));
    ...
    track.appendChild(drawStep(decisionNode, selectedUnit, inputNodes.length));
  } else {
    flow.steps.forEach((step, index) => {
      track.appendChild(drawStep(step, selectedUnit, index));
